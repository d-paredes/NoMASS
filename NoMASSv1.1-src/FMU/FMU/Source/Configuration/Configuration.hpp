...
//   Update -- daps -- 3.1.2017 Variable eplusVersion added to struct ConfigStructSimulation
...
class Configuration
    ...
    private:
        ...
        static void parseAgentHeatGains(rapidxml::xml_node<> *node);
        static void parseLights(rapidxml::xml_node<> *node);
        static void parseHeating(rapidxml::xml_node<> *node);
        ...
        static bool attributeNameIs(const rapidxml::xml_attribute<> *attribute, const char * str1);
        ...
        static const std::string stringToLower(const std::string str1);
